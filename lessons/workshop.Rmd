...
### 🥊 Challenge 6: 
Here, we have code below that is a bit untidy (missing indents, no comments, long single lines of code). Highlight the code below and in the chat ask Copilot to reformat this code and add comments.
```{r}
