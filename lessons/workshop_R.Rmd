...
💡 **Tip**: You can include the following commands (known as **"smart actions"**) in your chats to ask Copilot to do and reference specific things:
`@workspace` - Ask about your workspace
`@vscode` - Ask questions about VS Code
`@terminal` - Ask how to do something in the terminal

`/explain` - Explain how the referenced code works
`/fix` - Propose a fix for the problems in the selected code

`#selection` - Reference the currently selected or highlighted code
`#editor` - Reference the visible code in the active editor (i.e. on your screen)
`#file` - Choose a file in the workspace

For example, if you wanted to explain this file, you could prompt `#file workshop_R.Rmd What is the purpose of this file?`.

For more tips and smart actions checkout: https://code.visualstudio.com/docs/copilot/getting-started-chat
