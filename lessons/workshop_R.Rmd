...
Copilot can be really useful for cleaning up your code. For example, we have code below that is not very clean (missing indents, no comments, long single lines of code). We can ask Copilot to clean it up for us. Highlight the code below and in the chat ask Copilot to format this code and add comments.
```{r}
...
You may notice that you have to do some extra work to complete the clean-up; for example, you often may want to remove unnecessary or incorrect comments or add titles that are missing.

```{r}
# Paste new code here
```

We can take this clean-up a step further and ask it to make a function from our repetitive code. Highlight the code and ask Copilot to turn it into a function. 
