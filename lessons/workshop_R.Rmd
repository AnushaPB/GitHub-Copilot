...
### In-line Chat
You can start an in-line chat with copilot by pressing `Ctrl + I`. This will allow you to ask Copilot for help with the code you are currently writing. When you activate in-line chat while highlighting code, Copilot will edit the code in the highlighted area.
